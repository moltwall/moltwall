...
export type SourceType = "system" | "developer" | "user" | "memory" | "tool" | "web" | "external";
...
export declare class MoltWallSDKError extends Error {
    readonly statusCode: number;
    readonly code: string;
    constructor(message: string, statusCode: number, code: string);
}
/** @deprecated Use MoltWallSDKError */
export declare const AgentWallSDKError: typeof MoltWallSDKError;
